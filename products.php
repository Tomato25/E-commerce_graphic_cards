...
<?php 
		...
		"<div class='imgcont'><img src='data:image/jpeg;base64," .base64_encode($row["Img"]). "'/></div>" .
		 ...
		 "<br><b>In Stock: </b>" .$row["Stock"] .
		 "</p>" .
		 "</div>" .
		 "<a class='linkbtn' href=productdetail.php?ID=".$row["ProductID"].">Details</a>" .
		 "<form action='cartscript.php' method='POST'>" .
		 "<input type='hidden' name='prodID' value='" .$row["ProductID"]. "'>" .
		 "<input type='submit' value='ADD TO CART'>" .
		 "</form>" .
		  "<form action='wishscript.php' method='POST'>" .
		 "<input type='hidden' name='prodID' value='" .$row["ProductID"]. "'>" .
