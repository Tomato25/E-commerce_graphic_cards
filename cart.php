...
$username=$_SESSION["Username"]; 
$sql="SELECT p.ProductID, p.Name, p.Price, c.Username, p.Description FROM products p,carttable c WHERE p.ProductID=c.ProductID";
...
<?php 
		...
		echo "<div class='card'>" .
		 ...
		 "</p>" .
		 "</div>" .
		 "<a class='linkbtn' href=cartdelete.php?ID=".$row["ProductID"].">Delete</a>" .
		 "</div>";
		 }
?>
